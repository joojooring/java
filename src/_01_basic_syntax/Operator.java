...
//        논리 연산자 : 연산 결과 불리언(true/false)
        ...
        System.out.println("j && k >> " + (j && k)); //AND 연산자 j와 k 모두 참이어야 true
        System.out.println("j && l >> " + (j && l));
        System.out.println("j || k >> " + (j || k)); //OR연산자
        System.out.println("!j >> " + (!j));//NOT연산자
